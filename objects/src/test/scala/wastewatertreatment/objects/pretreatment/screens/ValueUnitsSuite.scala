...
class ValueUnitsSuite extends FlatSpec with Matchers {
  ...
  "ValueUnit(TSSRemoval(Some(27)))" should "27.00%" in {
    ValueUnit(TSSRemoval(Some(27))) shouldBe "27.00%"
  }
  ...
  "ValueUnit(TSSRemoval(Some(27), \"xyz/abc\"))" should "27.00xyz/abc" in {
    ValueUnit(TSSRemoval(Some(27), "xyz/abc")) shouldBe "27.00xyz/abc"
  }
  ...
  "ValueUnit(BOD5Removal(Some(27)))" should "27.00%" in {
    ValueUnit(BOD5Removal(Some(27))) shouldBe "27.00%"
  }
  ...
  "ValueUnit(BOD5Removal(Some(27), \"xyz/abc\"))" should "27.00xyz/abc" in {
    ValueUnit(BOD5Removal(Some(27), "xyz/abc")) shouldBe "27.00xyz/abc"
  }
